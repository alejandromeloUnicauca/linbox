...
/** @file matrix/blockedmatrix/sparse-block-allocator.h
 * @ingroup blockedmatrix
 * A \c DenseBlockAllocator<_Field>\c allocated a uniform grid of
 * \cSparseMatrix<_Field>\c for a \c BlockedMatrix<_Field,_Allocator>\c.
 *
 */

#ifndef __LINBOX_matrix_blockedmatrix_sparse_block_allocator_H
#define __LINBOX_matrix_blockedmatrix_sparse_block_allocator_H
...
namespace LinBox
{
	 ...
	 */
	template<class _Field, class _Storage = SparseMatrixFormat::SparseSeq>
	class SparseBlock : public Block<_Field>{
	public:
		typedef _Field                       Field;
		typedef typename Field::Element    Element;
		typedef SparseMatrix<Field, _Storage> Repr;
	...
	public:
		...
		SparseBlock(
			...
			Block<Field>::Block(BlockType::Spase, coord, owner),
			_repr(repr){}
		/**
		 *
		 */
		SparseBlock(
			...
			Repr* repr) :
			// Init list begins here.
			Block<Field>::Block(BlockType::SPARSE, i, j, owner),
			_repr(repr){}
		/**
		 *
		 */
		SparseBlock(const SparseBlock& rhs) :
			// Init list begins here.
		 ...
		 *
		 */
		SparseBlock& operator=(const SpaeseBlock& rhs){
			*_repr = *(rhs._repr);
			return *this;
		}
	 ...
	 */
	template<class _Field, class _Storage = SparseMatrixFormat::SparseSeq>
	class SpaseBlockAllocator{
	public:
		typedef _Field                      Field;
		typedef SparseBlock<Field>        Block_t;
		typedef SparseMatrix<Field,_Storage> Repr;
	...
	}; // end of class SparseBlockAllocator
} // end of namespace LinBox

#endif // __LINBOX_matrix_blockedmatrix_sparse_block_allocator_H
